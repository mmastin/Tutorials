# Works with generic_search.py file
...
class Maze:
    ...
    goal: MazeLocation = MazeLocation(9, 9)) -> None:
        ...
        self._grid: List[List[Cell]] = [[Cell.EMPTY for column in range(columns)]
    ...
    # return a nicely formatted version of maze for printing
